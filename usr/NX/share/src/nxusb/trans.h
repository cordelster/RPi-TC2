...
#ifndef EVEUSB_TRANS_H
#define EVEUSB_TRANS_H

#include "kmsg_types.h" // dev_id_t

struct message_up;
struct MsgHeader;
struct urb;

int fill_message_kernel_to_daemon(struct message_up *);
void fill_message_daemon_to_kernel(struct MsgHeader *);

void release_urb(struct urb *urb);
int send_device_destroyed(dev_id_t id);

#endif // EVEUSB_TRANS_H
